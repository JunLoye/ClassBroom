...
from PyQt6.QtGui import QFont, QPixmap, QPainter, QPen, QColor, QDesktopServices, QCursor
from PyQt6.QtCore import Qt, pyqtSignal, QThread, QUrl, QRectF, QPoint, QTimer, QSize
